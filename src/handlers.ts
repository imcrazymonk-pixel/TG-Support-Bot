...
const HELP_TEXT =
  'Просто напишите нам - и мы решим вашу проблему.\n' +
  'К сообщению можно сразу прикрепить фото, файл или видео.\n' +
  '\n' +
  '  • Не работает VPN - перед тем как писать, убедитесь что вы:\n' +
  '    - Обновили подписку\n' +
  '    - Обновили приложение\n' +
  '    - Удалили приложение и добавили подписку заново\n' +
  '    Если ошибка осталась - пришлите скриншот и опишите проблему.\n' +
  '\n' +
  '  • Нужна помощь с настройкой - укажите вашу платформу\n' +
  '    (Windows / iPhone / Android) и подробно опишите что делали.\n' +
  '\n' +
