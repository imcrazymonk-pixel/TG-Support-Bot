...
const HELP_TEXT =
  ...
  '\n' +
  '❓ Часто спрашивают:\n' +
  '  • Не работает VPN — пришлите скриншот ошибки\n' +
  '  • Вопрос по оплате — напишите никнейм и способ оплаты\n' +
  '  • Нужна настройка — укажите вашу платформу (Windows/iPhone/Android)\n' +
  '\n' +
